        ...
        specialisation.kanagawa.configuration = {
          ...
          home-manager.users.${user.name} = {
            ...
            home.file =  {
              ...
              ".config/doom" = {
                source = lib.mkForce "${inputs.dotfiles}/kanagawa/doom";
                recursive = true;
              };
        ...
        specialisation.tokyonight.configuration = {
          ...
          home-manager.users.${user.name} = {
            ...
            home.file = {
              ...
              ".config/doom" = {
                source = lib.mkForce "${inputs.dotfiles}/tokyonight/doom";
                recursive = true;
              };
              ".config/neomark/markdown.css" = {
        ...
        specialisation.rose-pine.configuration = {
          ...
          home-manager.users.${user.name} = {
            ...
            home.file = {
              ...
              ".config/doom" = {
                source = lib.mkForce "${inputs.dotfiles}/rosepine/doom";
                recursive = true;
              };
              ".config/neomark/markdown.css" = {
        ...
        specialisation.catppuccin.configuration = {
          ...
          home-manager.users.${user.name} = {
            ...
            home.file = {
              ...
              ".config/doom" = {
                source = lib.mkForce "${inputs.dotfiles}/catppuccin/doom";
                recursive = true;
              };
              ".config/neomark/markdown.css" = {
